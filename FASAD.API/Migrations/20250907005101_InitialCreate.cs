    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), "Has no permissions", "BasicUser" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), "Has view auth events permissions", "AuthObserver" },
                    { new Guid("00000000-0000-0000-0000-000000000003"), "Has view auth events and role changes permissions", "SecurityAuditor" }
                });
